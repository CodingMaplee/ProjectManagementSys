 ...
 * @version 2024-12-20
 */
@Table(name="core_sbgstmb", alias="a", label="设备工时条目表信息", columns={
		@Column(name="id", attrName="id", label="主键", isPK=true),
		@Column(name="project_id", attrName="projectId", label="项目Id"),
		@Column(name="sbgstmb_sbid", attrName="sbgstmbSbid", label="设备Id"),
		@Column(name="sbgstmb_sbmc", attrName="sbgstmbSbmc", label="设备名称"),
...
public class CoreSbgstmb extends DataEntity<CoreSbgstmb> {

	private static final long serialVersionUID = 1L;
	private String projectId;
	@ExcelField(title="设备Id")
	private String sbgstmbSbid;
	private String sbgstmbSbmc;// 项目Id
	...
	@Size(min=0, max=64, message="设备Id长度不能超过 64 个字符")
	public String getSbgstmbSbid() {
		return sbgstmbSbid;
	}

	public void setSbgstmbSbid(String sbgstmbSbid) {
		this.sbgstmbSbid = sbgstmbSbid;
	}

	@Size(min=0, max=64, message="设备Id长度不能超过 64 个字符")
	public String getSbgstmbSbmc() {
		return sbgstmbSbmc;
	}

	public void setSbgstmbSbmc(String sbgstmbSbmc) {
		this.sbgstmbSbmc = sbgstmbSbmc;
	}
